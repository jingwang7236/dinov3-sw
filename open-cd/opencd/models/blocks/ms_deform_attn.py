...
class MSDeformAttn(nn.Module):
    ...
    def forward(
        ...
        # Use pure PyTorch implementation for both forward and backward.
        # MSDeformAttnFunction requires a compiled CUDA extension for backward,
        # but ms_deform_attn_core_pytorch is built from differentiable ops
        # (grid_sample, softmax, etc.) and autograd handles the backward natively.
        output = ms_deform_attn_core_pytorch(
