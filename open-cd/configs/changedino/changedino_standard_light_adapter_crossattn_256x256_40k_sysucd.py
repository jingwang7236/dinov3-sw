# 在 changedino_standard_light_adapter_256x256_40k_sysucd.py 基础上，
# 将 decoder 的特征差分替换为双向交叉注意力 (ChangeDinoCrossAttnDecoder)
_base_ = [
...
model = dict(
    ...
    decode_head=dict(
        type='ChangeDinoCrossAttnDecoder',  # 交叉注意力替换特征差分
        fpn_channels=128,
        n_layers=[1, 1, 1, 1],
        num_classes=2,
        align_corners=False,
