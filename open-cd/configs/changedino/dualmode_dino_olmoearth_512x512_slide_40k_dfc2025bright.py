...
#   ① backbone_opt 改为开源的dino模型
#   ② backbone_sar 改为开源的olmoearth模型
# ============================================================================

# 已解决: 512 输入报错的根因是 adaptive_pool 的固定输出尺寸 (256 设计) 与 OPT 分支
# 不匹配, 关闭 adaptive_pool 即可 (SAR 自然多尺度输出已与 OPT 对齐)。
