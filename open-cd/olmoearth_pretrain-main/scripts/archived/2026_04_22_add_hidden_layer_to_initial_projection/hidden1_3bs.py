"""Add hidden layer to the initial projection layer (default multi-bandset tokenization).

Same as ``hidden1.py`` but trains on the default bandsets (3 for Sentinel-2,
2 for Landsat) rather than collapsing each modality into a single bandset.
"""
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    WANDB_PROJECT = "2026_05_11_v1_1_1_3bs"
