"""ST encoder with windowed attention + single bandset + random band dropout (no S1) + random time with decode masking + masked-negatives loss.

- ST encoder with windowed_attention_size=5 (decoder uses full attention)
