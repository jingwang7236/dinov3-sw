...
################################### default time #############################################
experiment_name = '001_mtp_vitb_diorr_test'
work_dir = f'./work_dirs/mtp/dior/{experiment_name}'
...
data_root = '/mnt/mty/datasets/DIOR/'
backend_args = None
...
model = dict(
    ...
    backbone=dict(
        ...
        pretrained = '/mnt/mty/open_source_mm/last_vit_b_rvsa_ss_is_rd_pretrn_model_encoder.pth'
        #   '/work/share/achk2o1zg1/diwang22/work_dir/multitask_pretrain/pretrain/avg/with_background/vit_b_rvsa_224_mae_samrs_mtp_three/last_vit_b_rvsa_ss_is_rd_pretrn_model_encoder.pth'
        ),
    neck=dict(
        type='mmdet.FPN',
