_base_ = [
    '/mnt/mty/open_source_mm/mmrotate-1.x/configs/_base_/datasets/dota.py', 
...
experiment_name = '003_dotav10_multiscale_dinov3_load_from_sat493m_pretrain_add_fpn_12e_amp'
