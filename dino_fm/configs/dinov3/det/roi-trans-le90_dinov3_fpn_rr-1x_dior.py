_base_ = [
    '/mnt/mty/open_source_mm/mmrotate-1.x/configs/_base_/datasets/dior.py', 
...
experiment_name = '010_dior_roi_trans_dinov3_fix_config_load_from_chinasiwei153w_pretrain_add_fpn_12e_bs4_amp'
work_dir = f'./work_dirs/dinov3/dior/{experiment_name}'
