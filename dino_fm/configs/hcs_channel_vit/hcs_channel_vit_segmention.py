...
experiment_name = '001_hcs_channel_vit_debug'
...
load_from = '/mnt/mty/open_source_mm/mmpretrain/projects/dino/work_dirs/001_channel_vit_dino_debug/epoch_54_BK.pth'

model = dict(
    type='ChannelEncoderDecoder',
    data_preprocessor=data_preprocessor,
    # pretrained='/mnt/mty/open_source_mm/mmpretrain/projects/dino/work_dirs/001_channel_vit_dino_debug/epoch_54_BK.pth',
    pretrained=None,
    backbone=dict(
