...
import torch
torch.hub.set_dir('/mnt/mty/.torch_hub')
...
def _make_dinov3_vit(
    ...
    **kwargs,
    ...
    if pretrained:
        ...
        strict = False if channel_adaptive and feat_fuse_method == 'conv' else True
